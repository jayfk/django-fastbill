...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Subscription.fastbill_customer'
        db.delete_column(u'django_fastbill_subscription', 'fastbill_customer_id')

        # Deleting field 'Subscription.fastbill_article'
        db.delete_column(u'django_fastbill_subscription', 'fastbill_article_id')

        # Deleting field 'Invoice.fastbill_customer'
        db.delete_column(u'django_fastbill_invoice', 'fastbill_customer_id')

        # Deleting field 'Invoice.fastbill_subscription'
        db.delete_column(u'django_fastbill_invoice', 'fastbill_subscription_id')


    def backwards(self, orm):
        # Adding field 'Subscription.fastbill_customer'
        db.add_column(u'django_fastbill_subscription', 'fastbill_customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', null=True, to=orm['django_fastbill.Customer']),
                      keep_default=False)

        # Adding field 'Subscription.fastbill_article'
        db.add_column(u'django_fastbill_subscription', 'fastbill_article',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', null=True, to=orm['django_fastbill.Article']),
                      keep_default=False)

        # Adding field 'Invoice.fastbill_customer'
        db.add_column(u'django_fastbill_invoice', 'fastbill_customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoices', null=True, to=orm['django_fastbill.Customer']),
                      keep_default=False)

        # Adding field 'Invoice.fastbill_subscription'
        db.add_column(u'django_fastbill_invoice', 'fastbill_subscription',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoices', null=True, to=orm['django_fastbill.Subscription']),
                      keep_default=False)
